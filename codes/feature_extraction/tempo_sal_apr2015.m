function [dft_acf_represent, tempo, sal, sal_acf,sl] = tempo_sal_apr2015( acf_represent,fft_represent )

szf=size(fft_represent);

hop_acf=0.010;   % in s each lag in acf represent

bin_fft=50/szf(1); % in Hz what bin represent
